...
export declare class LoginRequest extends Message<LoginRequest> {
  ...
  static readonly typeName = "admiral.authn.v1.LoginRequest";
...
export declare class LoginResponse extends Message<LoginResponse> {
   ...
   *
   * @generated from oneof admiral.authn.v1.LoginResponse.return
   */
  return: {
    /**
    ...
    /**
     * @generated from field: admiral.authn.v1.LoginResponse.Token token = 2;
     */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.authn.v1.LoginResponse";
  static readonly fields: FieldList;
...
export declare class LoginResponse_Token extends Message<LoginResponse_Token> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.authn.v1.LoginResponse.Token";
  static readonly fields: FieldList;
...
export declare class CallbackRequest extends Message<CallbackRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.authn.v1.CallbackRequest";
  static readonly fields: FieldList;
...
export declare class CallbackResponse extends Message<CallbackResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.authn.v1.CallbackResponse";
  static readonly fields: FieldList;
...
export declare class CreateTokenRequest extends Message<CreateTokenRequest> {
   ...
   *
   * @generated from field: admiral.authn.v1.CreateTokenRequest.TokenType token_type = 3;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.authn.v1.CreateTokenRequest";
  static readonly fields: FieldList;
...
export declare class CreateTokenResponse extends Message<CreateTokenResponse> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.authn.v1.CreateTokenResponse";
  static readonly fields: FieldList;
