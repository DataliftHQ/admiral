...
export declare class Action extends Message<Action> {
   ...
   *
   * @generated from field: admiral.common.v1.ActionType type = 1;
   */
  type: ActionType;
  ...
  static readonly typeName = "admiral.common.v1.Action";
...
export declare class Pattern extends Message<Pattern> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.common.v1.Pattern";
  static readonly fields: FieldList;
...
export declare class Identifier extends Message<Identifier> {
  /**
   * @generated from field: repeated admiral.common.v1.Pattern patterns = 1;
   */
  patterns: Pattern[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.common.v1.Identifier";
  static readonly fields: FieldList;
...
export declare class Reference extends Message<Reference> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.common.v1.Reference";
  static readonly fields: FieldList;
...
export declare class Redacted extends Message<Redacted> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.common.v1.Redacted";
  static readonly fields: FieldList;
