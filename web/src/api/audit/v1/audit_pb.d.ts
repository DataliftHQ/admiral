...
export declare class TimeRange extends Message<TimeRange> {
  ...
  static readonly typeName = "admiral.audit.v1.TimeRange";
...
export declare class GetEventsRequest extends Message<GetEventsRequest> {
  /**
   * @generated from oneof admiral.audit.v1.GetEventsRequest.window
   */
  window: {
    /**
     * @generated from field: admiral.audit.v1.TimeRange range = 1;
     */
    value: TimeRange;
    case: "range";
  } | {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.GetEventsRequest";
  static readonly fields: FieldList;
...
export declare class Resource extends Message<Resource> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.Resource";
  static readonly fields: FieldList;
...
export declare class RequestMetadata extends Message<RequestMetadata> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.RequestMetadata";
  static readonly fields: FieldList;
...
export declare class ResponseMetadata extends Message<ResponseMetadata> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.ResponseMetadata";
  static readonly fields: FieldList;
...
export declare class RequestEvent extends Message<RequestEvent> {
   ...
   *
   * @generated from field: admiral.common.v1.ActionType type = 4;
   */
  type: ActionType;
   ...
   *
   * @generated from field: repeated admiral.audit.v1.Resource resources = 6;
   */
  resources: Resource[];
   ...
   *
   * @generated from field: admiral.audit.v1.RequestMetadata request_metadata = 7;
   */
   ...
   *
   * @generated from field: admiral.audit.v1.ResponseMetadata response_metadata = 8;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.RequestEvent";
  static readonly fields: FieldList;
...
export declare class Event extends Message<Event> {
  ...
  /**
   * @generated from oneof admiral.audit.v1.Event.event_type
   */
  eventType: {
    /**
     * @generated from field: admiral.audit.v1.RequestEvent event = 2;
     */
    value: RequestEvent;
    case: "event";
  } | { case: undefined; value?: undefined };
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.Event";
  static readonly fields: FieldList;
...
export declare class GetEventsResponse extends Message<GetEventsResponse> {
  /**
   * @generated from field: repeated admiral.audit.v1.Event events = 1;
   */
  events: Event[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.GetEventsResponse";
  static readonly fields: FieldList;
...
export declare class GetEventRequest extends Message<GetEventRequest> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.GetEventRequest";
  static readonly fields: FieldList;
...
export declare class GetEventResponse extends Message<GetEventResponse> {
  /**
   * @generated from field: admiral.audit.v1.Event event = 1;
   */
  event?: Event;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "admiral.audit.v1.GetEventResponse";
  static readonly fields: FieldList;
